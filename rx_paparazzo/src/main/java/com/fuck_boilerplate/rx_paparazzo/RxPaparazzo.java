...
public final class RxPaparazzo {
    ...
    public static class BuilderImage<T> extends Builder<T> {
        ...
        /**
         * Calling it the images will be saved in internal storage, otherwise in public storage (don't use with [@see dirPath method])
         */
    ...
    public static class BuilderImages<T> extends Builder<T> {
         ...
         * Set path for output dir (create output path if not exist).
         */
        public BuilderImages<T> dirPath(String outputDirPath) {
            this.config.setDirPath(outputDirPath);
            return this;
        }

        /**
         * Set name for photo [prefix + sufix generated by name generator].
         */
        public BuilderImages<T> fileName(String outputFileNamePrefix, Config.SufixNameGenerator nameGenerator) {
            this.config.setFileName(outputFileNamePrefix, nameGenerator);
            return this;
        }
